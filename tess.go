...
#cgo windows,amd64 LDFLAGS: -L${SRCDIR}/etc/lib/windows_amd64 -lyogacore -static-libstdc++ -static-libgcc -lm
#cgo windows,arm64 LDFLAGS: -L${SRCDIR}/etc/lib/windows_arm64 -lyogacore -static-libstdc++ -static-libgcc -lm
#include <yoga/Yoga.h>
#include "tess_ext.h"
*/
import "C"
